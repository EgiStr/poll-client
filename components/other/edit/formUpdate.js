...
const formUpdate = ({ id, title,desc  }) => {
        ...
        <>
            <div className="flex flex-col w-full">
                ...
                <div className="flex mt-4">
                    <input id='private' onChange={e => handleCheck(e)}  type="checkbox" className="form-checkbox h-5 w-5 text-base-700" /><label htmlFor="private" className="ml-2 text-base-400">Private ( vote only via link )</label>
                </div>
                <div className="flex mt-4 mb-2">
                    <input id='result_private' onChange={e => handleCheck(e)} type="checkbox" className="form-checkbox h-5 w-5 text-base-700" /><label htmlFor="result_private" className="ml-2 text-base-400">Private result( only you can in result )</label>
                </div>
