        ...
        <>
            <div className="reply ml-4 flex flex-col pt-1 pl-3 border-l border-gray-500 ">
                ...
                <div className="flex pb-3">
                    <div className="block px-2 text-xs sm:text-sm italic text-base-400">
                        {timestamp}
                ...
                <div className="reply-reply ml-4 flex flex-col ">
                    ...
                    : replies.length > 0 && 
                                        <>
                                        <Link href={`/comment/${id}`}><a><p className="text-xs sm:text-sm font-thin bg-basefont-600 sm:w-1/3 rounded-3xl w-full inline-flex justify-center justify-items-center">continue thered {replies.length}</p></a></Link>
                                        </>
                    }
                </div>
            </div>
