        ...
        <>
            <div className="flex sm:justify-center">
                <div className="flex flex-col">
                    ...
                    <p className="antialiased text-opacity-80 text-base-400 italic sm:ml-8">Start about {create_at}</p>
                </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between">
                {deadlineAnswer ? 
                    <button disabled className="transition  duration-300 ease-in-out opacity-40 cursor-not-allowed bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border-blue-700 rounded w-full sm:w-3/12">
                        {loading ? 'Loading' : 'VOTE'}
                    </button>
                :
                    <button onClick={() => handleVote()} className="transition  duration-300 ease-in-out focus:outline-none focus:shadow-outlin bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border-blue-700 rounded w-full sm:w-3/12">
                        {loading ? 'Loading' : 'VOTE'}
                    </button>
                }
